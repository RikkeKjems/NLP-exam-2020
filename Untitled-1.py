...
# %%
# Retter til at være float
df['Unique_occ_perc'].astype(float)

# Her omdanner vi til quartiles for hver kolonne
# %%
# MAX_WORD_LENGTH
...
# %%
# GEMMER SÅ VI HAR DET HELE I EN CSV
...
# %%
df.to_csv(r'Data/CSV/newquar.csv')
...
# %%
# Loading the data
df = pd.read_csv('Data/CSV/newquar.csv')
...
features = ['D_or_ND', 'max_word_length_quar', 'Most_common_word_length_quar',
            ...
            'Verb_perc_quar', 'Adj_perc_quar', 'Pron_perc_quar', 'Adv_perc_quar', 'Prop_perc_quar']
...
dt = DecisionTreeClassifier(random_state=37, criterion='gini')
dt.fit(X, y)
...
# C skal være 0.162378 for lowest logg loss (0.494137) med en CA på 0.857143
...
# Testing Acc: 0.7142857142857143
# Log Loss: 0.4335872880364064
# %%
