...
df = df.drop(columns=['Unnamed: 0', 'Unnamed: 0.1', 'File'])
...
features = ['D_or_ND', 'max_word_length',
            'Most_common_word_length', 'Nouns', 'Verbs', 'Adjs',
            'Prons', 'Advs', 'Props', 'Max_word_length_occ']
...
# Take only the colums who has a feature importance above 0.00
